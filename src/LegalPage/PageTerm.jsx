  ...
  return (
    <>  
        ...
        <div className='TermsCondition'>
            ...
            <p style={{textAlign: 'justify', textIndent: '5%', marginBottom: 30}}><strong>Introduction:</strong> These Website Standard Terms and Conditions written on this webpage shall manage your use of this website. These Terms will be applied fully and affect your use of this Website. By using this Website, you agree to accept all terms and conditions written here. You must not use this Website if you disagree with any of these Website Standard Terms and Conditions.</p>
                <h3>1. Eligibility</h3>
                ...
                <h3>4. Data Privacy</h3>
                    <li>Your personal data will be collected and used in accordance with the <a href="https://privacy.gov.ph/data-privacy-act/" target="_blank" rel="noopener noreferrer"><u>Data Privacy Act of 2012 (RA 10173)</u></a>.</li>
